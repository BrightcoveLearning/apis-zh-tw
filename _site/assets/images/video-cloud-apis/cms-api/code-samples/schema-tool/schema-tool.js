                ...
                try {
                    if (httpRequest.readyState === 4) {
                        if (httpRequest.status >= 200 && httpRequest.status < 300) {
                            ...
                            videoData.url = 'https://https://players.brightcove.net/' + account_id + '/default_default/index.html';
                            generateSchema();
